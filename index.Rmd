---
title: "STAR"
subtitle: "Step Towards<br>Academic Research"
author: "Ajay Koli"
...
# .ttu.white[`r rmarkdown::metadata$subtitle`]

### .white.b[`r rmarkdown::metadata$author`]
...
## .right["Educate. Agitate. Organise."]
...
[Ajay Koli](https://koliajay.netlify.app/)<br>
Head of School of Data Science<br>
Nalanda Academy - Wardha, India<br>`r icons::fontawesome$solid$envelope` [koliajaykumar@gmail.com](koliajaykumar@gmail.com)<br>`r icons::fontawesome$brands$twitter` [@ajay_kolii](https://twitter.com/ajay_kolii)
...
- Schedule:
  - `r emo::ji("date")` 24 to 27 May 2022
  
  - `r emo::ji("alarm_clock")` from 08:00 to 11:00 AM & 14:00 to 18:00 PM IST
...
- This Research Methodology Workshop is organised by the [Nalanda Academy](https://nalanda-academy.org/) to:
...
## .blue["in our .b[everyday reasoning] about the social world, prior experiences and orientations may have a major influence on what we perceive and how we interpret these perceptions.] ... 
--
.green[We need to move .b[beyond first impressions] and get reactions to more systematic methods of investigation. That’s what social research does."]<sup>2</sup>

---

class: center

### .orange.left[But is it easy to move beyond the first impressions knowledge?] 

--

.pull-left[
```{r bruno, out.width="80%", fig.cap="Giordano Bruno"}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/1/15/Giordano_Bruno.jpg")
```
]
...
.pull-right[
```{r savitri, out.width="90%", fig.cap="Savitribai Phule"}
knitr::include_graphics("https://thelogicalindian.com/h-upload/2022/01/03/209612-untitled-design-6.jpg")
```
]
...
###- How similar or different is your cooked food? <br>.green[Discussion]
...
.pull-right[
```{r error-img2, out.width="100%", fig.align='center'}
knitr::include_graphics("images/error.png")
```
]
...
.pull-right[
```{r error-img3, out.width="100%", fig.align='center'}
knitr::include_graphics("images/error.png")
```
]
...
.pull-right[
```{r error-img4, out.width="100%", fig.align='center'}
knitr::include_graphics("images/error.png")
```
]
...
```{r raul, out.width="55%"}
knitr::include_graphics("images/raul.png")
```
...
###- .green[“You don’t have to eat the whole tub of butter to know if it’s rancid.” Harsh, but true.]
...
knitr::include_graphics("images/srm.jpeg")
```
...
knitr::include_graphics("images/systematic.jpeg")
```
...
```{r echo=FALSE, fig.align='center', out.width="50%"}
knitr::include_graphics("images/strata.jpeg")
```
...
```{r echo=FALSE, fig.align='center', out.width="55%"}
knitr::include_graphics("images/snow.jpeg")
```
...
knitr::include_graphics("https://perspectivesinanthropology.files.wordpress.com/2015/01/ethnographic_immersion-1.jpg")
```
...
background-image: url("https://images.unsplash.com/photo-1610209455607-89e8b3e0e393?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770")
background-size: cover

# .white.big-text[Congratulations!!<br>&<br>thank you `r emo::ji("hug")`]