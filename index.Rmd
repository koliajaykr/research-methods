...
```{r out.width="70%"}
knitr::include_graphics("https://images.unsplash.com/photo-1562386502-cc212ede3c40?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=790&q=80")
```
...
1. Review the relevant research literature, and assess the utility of variables used in prior research.

--

1. Consider the constraints and opportunities for measurement that are associated with the specific setting(s) we will study. Distinguish constants from variables in this setting.

--

1. Look ahead to our analysis of the data. What role will each variable play in our analysis?
